...
<KeySnailPlugin>
    ...
    <description lang="ja">KeySnail �? Twitter クライアントに</description>
...
ス�?ータスバ�?�の Twitter アイコンを左クリ�?クすることで Twitter の TimeLine が表示されます�??

これは M-x などのキーから ext.select() を呼び出�? twitter-client-display-timeline を選ぶのと同じことです�??

次のようにして任意�?�キーへコマンドを割り当てておくことも可能です�??
...
上記�?�ようなコードを .keysnail.js へ記述しておくことにより (以�? 「設定を行う�? と表�?)、ブラウズ画面において t キーを押すことでこ�?�クライアントを起動させることが可能となります�??

タイ�?ラインを表示させず即座につぶ�?きた�?と�?�?場合には、次のような設定がおすすめです�??
...
こうした設定を行っておくと C-c t を押すことで即座につぶ�?き画面を表示することが可能となります�??

閲覧して�?る�?��?�ジのタイトルと URL をつぶ�?くことも可能です�?�以下�?�ような設定を行っておきましょ�?�?

>|javascript|
key.setGlobalKey(["C-c", "T"],
    function (ev, arg) {
        ext.exec("twitter-client-tweet-this-page", arg);
    }, "こ�?�ペ�?�ジのタイトルと URL を使ってつぶ�?�?", true);
||<

==== キーバインド�?�設�? ====

次のような設定を .keysnail.js の PRESERVE エリアへ貼り付けておくと、�?�段に操作がしやすくなります�??
(先ほどとは異な�? .keysnail.js 先�?�の PRESERVE エリアへ設定コードを記述しなければならな�?ことに注意してください)
...
どのようなキーバインドとなって�?るかは、設定を見て�?ただければ�?かるでしょ�?。気に入らなければ変更することも可能です�??

こ�?�ままではアルファベットが入力できな�?ので、もし絞り込み検索を行うためにアルファベットを入力したくなった�?�合�?��? C-z キーを�?�力するか 「閉じる�? ボタン左の 「地�?マ�?�ク�? をクリ�?クし�?�編�?モードへと�?り替えてください�?

==== Enter ではな�? Ctrl + Enter でポストするよ�?に ====

Enter では誤�?が多いので Ctrl + Enter でポストするよ�?にした�?、と�?�?方は次のような設定を .keysnail.js の PRESERVE エリアへ貼り付けておくとよいでしょ�?�?
...
TL 上部の 「�?�ッ�?�? 部�?には�?選択中ユーザのアイコン�?メ�?セージなどが表示されます�?�ユーザ名やアイコンの上へマウスカーソルを持って�?くことで、そのユーザの自己紹介文を見ることが可能です�??

また�?�メ�?セージ中に @username と�?った表記や http:// と�?っ�? URL があった�?�合�?�自動的にリンクが貼られます�?�このリンクをそのまま左クリ�?クすると、リンク先へジャンプします�??

また�?�リンクの上で右クリ�?クをすることにより、様�??な処�?を選ぶことも可能となって�?ます�?�例えば j.mp �? bit.ly のリンク上で右クリ�?クをすれ�?�、その URL が何回クリ�?クされたかを調査することができます�?��?��?の紹介し�? URL が�?�然クリ�?クされて�?なくても�?�気にしな�?ようにしましょ�?。世�?�中そんなも�?�です�??

ヘッ�?右上�?� 「閉じる�? ボタンは見落とされがちですが、有事�?�際には�?ず役に立ってくれることでしょ�?�?

==== リス�? ====

リスト�?�閲覧を行うためには .keysnail.js �?であらかじ�?閲覧した�?リストを登録しておく�?要があります�??
...
twitter_client.lists には "ユーザ�?/リスト名" と�?った文字�?�からなる�?��?�を�?定します�?�ゆえに、�?��?の作�?�したリストだけでなく他�?�ユーザの作�?�したリストを登録することも可能です�??

閲覧した�?リスト�?�、�?�ウスを使�?ヘッ�?のリスト�?覧をクリ�?クするか�?�キーボ�?�ドを使�? switch-to (C-i と押して選択するか、上�?�設定を行った�?�合�?�単に s と押せ�?�よい) を実行することで選択できます�??

==== ス�?ータスバ�?�アイコン ====

ス�?ータスバ�?�には二種類�?�アイコンが追�?されます�??

「吹き�?�し�?? アイコンを左クリ�?クすると自�?の TL が�?? 「封筒�?? アイコンを左クリ�?クすると自�?宛�?�メ�?セージ (Mentions) が�?覧表示されます�??

また�?�それぞれ�?�アイコンを右クリ�?クすることで、それ以外にも様�??なコマンドを実行することが可能です�??

==== アクションの選�? ====

タイ�?ライン�?覧でそ�?�まま Enter キーを�?�力すると、つぶ�?き画面へ移行することができます�??

Enter ではな�? Ctrl + i キーを押すことにより、様�??なアクションを選ぶことも可能となって�?ます�??

==== ち�?っと便利な使�?方 ====

例えばみんながつぶ�?�?て�?る�?��?�ジを�??番に見て�?きた�?と�?�?とき�?�、次のようにします�??

+ Ctrl + i を押して 「メ�?セージ中の URL を開く�?�にカーソルを合わせ�?
+ もう�?度 Ctrl + i を押して TL �?覧へ戻�?
+ http と打ち込んで URL の載って�?るつぶ�?きだけを�?覧表示する
+ あとは Ctrl + Enter を押して (Ctrl が�?�イント�?) �?番にペ�?�ジを開�?て�?�?

ね、簡単でしょ�??�?

==== 自動更新  ====

こ�?�クライアント�?�起動時にタイマ�?�をセ�?トし Twitter のタイ�?ラインを定期�?に更新します�??

twitter_client.update_interval に値を設定することにより、この間隔を変更することが可能となって�?ます�??

==== ポップア�?プ�?�知  ====

twitter_client.popup_new_statuses オプション�? true に設定されて�?れ�?�、新しいつぶ�?きが届いた際にポップア�?プで通知が行われるようになります�??

また�?�クライアント実行中にもアクションからこ�?�値を�??り替えることが可能です�??

=== つぶ�?き専用 ===

つぶ�?き専用で TL の表示はしな�?、�?�動更新とかも�?らな�?よ�?�と�?�?方向けの設定を以下に示します�??
...
こ�?�設定�?� http://10sr.posterous.com/tltweetkeysnail-yatwitterclient を参�?にさせて�?ただ�?たものです�??
]]></detail>
</KeySnailPlugin>;
...
let pOptions = plugins.setupOptions("twitter_client", {
    ...
    "unread_status_count_style"    : {
        ...
        description: M({
            ja: "ス�?ータスバ�?�へ表示される未読ス�?ータス数のスタイル�? CSS で�?�?",
    ...
    "automatically_begin"          : {
        preset: true,
        description: M({
            ja: "プラグインロード時、�?�動的にス�?ータスの取得を開始するかど�?�?",
    ...
    "automatically_begin_list"     : {
        preset: true,
        description: M({
            ja: "プラグインロード時、�?�動的にリスト�?�ス�?ータスの取得を開始するかど�?�?",
    ...
    "prefer_screen_name": {
        preset: false,
        description: M({
            ja: "TL �?覧などでユーザ名�?�代わりに ID (screen name) を表示した�?場�? true へ設�?",
    ...
    "use_jmp"                               : {
        ...
        description: M({en: "Use j.mp or not. If not, URLs will be automatically shortened by Twitter.",
                        ja: "j.mp をつかって URL を短縮するか指定します�?�しな�?場合�?? Twitter が�?�動で短縮します�??" })
    },
    "jmp_id"                                : {
        preset: "stillpedant",
        description: M({en: "Specify ID of your j.mp account if you want use your one",
                        ja: "j.mp の URL 短縮で独自アカウントを用�?たい場合�?�その ID を指�?" })
    },
    "jmp_key"                               : {
        preset: "R_168719821d1100c59352962dce863251",
        description: M({ ja: "j.mp の URL 短縮で独自アカウントを用�?たい場合�?�その Key を指�?",
    ...
    "hide_profile_image_gif"                : {
        preset: false,
        description: M({ ja: "ユーザのアイコン�? Gif 画像であった�?�合�?��?�?",
                         en: "When user icon is Gif, hide it" })
    },
    "show_screen_name_on_tweet": {
        preset: false,
        description: M({ ja: "�?イート�?�力時に自�?のスクリーン名を表示する",
                         en: "Display your screen name in tweet box." })
    },
    "filters": {
        preset: [],
        description: M({ ja: "�? status (つぶ�?�?) はこ�?�オプションに登録された関数に渡され�?関数�? false, null, undefined など falsy な値を返した�?�合�?��?覧から削除されます�??",
                         en: "Remove tweets when one of the functions returns falsy value." })
    },
    "list_include_rts": {
        preset: true,
        description: M({ ja: "リスト�?�タイ�?ラインに公式RTを含めるかど�?�?",
   ...
   "user_include_rts": {
        preset: true,
        description: M({ ja: "ユーザのタイ�?ラインに公式RTを含めるかど�?�?",
...
function OAuth(info, tokens) {
    ...
    if (!userscript.require("oauth.js", context)) {
        display.notify(PLUGIN_INFO.name + " : " +
                       M({ja: "こ�?�プラグインの動作には oauth.js が�?要です�?? oauth.js を�?�ラグイン�?ィレクトリ�?に配置した上でお試し下さ�?�?",
    ...
    function ensureReauthorizationNotRequired(xhr) {
        if ((twitterAPI.isDMManipulationNotAllowed(xhr) || twitterAPI.isTokenExpired(xhr)) &&
            ...
            display.showPopup(M({
                ...
                ja: "以前に認証したト�?�クンが無効な�?し古くなってしまって�?ます．�?�認証を行なって下さ�?�?",
    ...
    (function () {
        ...
        var gTwitterCommonActions = [
            ...
            [function (status) {
             ...
             }, M({ja: "こ�?�つぶ�?�? => 返信 : ", en: ""}) + "Send reply message",
             "reply"],
            // ======================================== //
            [function (status) {
                 if (status)
                 {
                     if (status.raw && status.raw.user && status.raw.user.protected &&
                         !window.confirm(M({ ja: "こ�?�ユーザはつぶ�?きを非�?�開にして�?ます�?�それでも非公�? RT を行いますか?�?",
            ...
            [function (status) {
             ...
             }, M({ja: "こ�?�ユーザ => �?近�?�つぶ�?�? : ", en: ""}) + "Show Target status",
             "show-target-status,c"],
            // ======================================== //
            [function (status) {
                 if (status) sendDM(status.screen_name, status.id_str);
             }, M({ja: "こ�?�ユーザ => �?イレクトメ�?セージ (DM) を�?�信 : ", en: ""}) + "Send Direct Message (DM)",
             "send-direct-message"],
            // ======================================== //
            [function (status) {
                 if (status) showFavorites(status.user_id);
             }, M({ja: "こ�?�ユーザ => ふぁぼり�?覧を表示 : ", en: ""}) + "Show this user's favorites",
             "show-user-favorites"],
            // ======================================== //
            [function (status) {
                 if (!status) return;
                 showLists(status.screen_name);
             }, M({ja: "こ�?�ユーザ => リストを�?覧表示 : ", en: ""}) + "Show selected user's lists",
             "show-selected-users-lists"],
            // ======================================== //
            [function (status) {
                 if (status) addUserToBlacklist(status.screen_name);
             }, M({ja: "こ�?�ユーザ => ブラ�?クリストへ追�? : ", en: ""}) + "Add this user to the blacklist",
             "add-user-to-blacklist,c"],
            // ======================================== //
            [function (status) {
                 if (status) showMentions();
             }, M({ja: "自�?に関連したつぶ�?�? @ を�?覧表示 : ", en: ""}) + "Show mentions",
             "show-mentions"],
            // ======================================== //
            [function (status) {
                 if (status) self.showDMs();
             }, M({ja: "自�?宛�?� DM を�?覧表示: ", en: ""}) + "Show DMs",
             "show-dms"],
            // ======================================== //
            [function (status) {
                 if (status) self.tweetWithTitleAndURL();
             }, M({ja: "現在のペ�?�ジのタイトルと URL を使ってつぶ�?�? : ", en: ""}) + "Tweet with the current web page URL",
             "tweet-current-page"],
            // ======================================== //
            [function (status) {
                 if (status) search();
            ...
            [function (status) {
             ...
             }, M({ja: "メ�?セージ中の URL を開�? : ", en: ""}) + "Visit URL in the message",
             "open-url,c"],
            // ======================================== //
            [function (status) {
            ...
            [function (status) {
             ...
             }, M({ja: "更新 / TL へ戻�?", en: "Refresh / Display TL"}),
             "refresh-or-back-to-timeline"],
            [function (status) {
                 switchTo();
             }, M({ja: "移�? (リス�?, Home, Mentions, ...)", en: "Switch to (Lists, Home, Mentions, ...)"}),
             "switch-to"],
            [function (status) {
        ...
        function blackUsersManager() {
            ...
            prompt.selector(
                {
                    message    : M({ja: "ユーザの管�?", en: "Manage users"}) +
        ...
        if (!container) {
            ...
            let menu = my.twitterClientStatusBarMenu = createMenu([
                [M({ja: "お気に入り�?覧", en: "Display favorites"}), "f",
                 Commands.execExt("twitter-client-show-favorites")],
                [M({ja: "自�?のス�?ータス�?覧", en: "Display my statuses"}), "m",
                 Commands.execExt("twitter-client-show-my-statuses")],
                [M({ja: "自�?のリスト�?覧", en: "Display my lists"}), "l",
                 Commands.execExt("twitter-client-show-my-lists")],
                [M({ja: "ブラ�?クリスト�?�管�?", en: "Launch blacklist manager"}), "b",
        ...
        if (!my.twitterClientHeader)
        {
            ...
            let tooltipTextTwitter     = M({ja: "こ�?�ユーザの Twitter ペ�?�ジへ", en: "Visit this user's page on twitter"});
            let tooltipTextHome        = M({ja: "こ�?�ユーザのホ�?��?ペ�?�ジへ", en: "Visit this user's homepage"});
            let tooltipTextRefresh     = M({ja: "更新", en: "Refresh"});
            let tooltipTextClose       = M({ja: "閉じ�?", en: "Close"});
            let tooltipTextAddTracking = M({ ja: 'トラ�?キングワードを追�?', en: 'Add new tracking word' });

            let labelTimeline = M({ja: "タイ�?ライン", en: "Timeline"});
            ...
            applyMenu(my.twitterClientHeader.normalMenu, [
                [M({ja: "コピ�?�", en: "Copy"}), "c", root + ".copyCurrentStatus();"],
                [M({ja: "返信", en: "Reply"}), "r", root + ".replyToCurrentStatus();"],
                ["Retweet (Quote tweet)", "q", root + ".retweetCurrentStatus();"],
                [null, null, null],
                [M({ja: "こ�?�ユーザ", en: "This user"}), "u",
                 [
                     [M({ja: "�?近�?�つぶ�?�?", en: "Display this user's statuses"}), "s",
                      root + ".showCurrentTargetStatus();"],
                     [M({ja: "リスト�?覧", en: "Display this user's lists"}), "l",
                      root + ".showCurrentTargetLists();"],
                     [M({ja: "ブラ�?クリストへ追�?", en: "Add this user to the black list"}), "b",
            ...
            share.twitterAPIUsage = {
                ...
                update: function () {
                    ...
                    let toolTip   = "    Twitter API Usage / Limit    \n" +
                        "    " + M({ja: "制限リセ�?ト日�?", en: "Limit reset in "}) + "   " + util.format("%s:%s", hour, min);
        ...
        function getElapsedTimeString(aMillisec) {
            ...
            if (sec < 1.0)
                return M({ja: "つ�?さっ�?", en: "just now"});
            var min = sec / 60;
            if (min < 1.0)
                return format(sec, M({ja: "秒前", en: "seconds ago"}));
            var hour = min / 60;
            if (hour < 1.0)
                return format(min, M({ja: "�?�?", en: "minutes ago"}));
            var date = hour / 24;
            if (date < 1.0)
                return format(hour, M({ja: "時間�?", en: "hours ago"}));
            return format(date, M({ja: "日�?", en: "days ago"}));
        }
        ...
        function showFavorites(aTargetID) {
            processFavorites(function (favorites) {
                callSelector(favorites, M({ ja: "お気に入り�?覧", en: "Favorites" }), {
        ...
        function copy(aMsg) {
            ...
            display.echoStatusBar(M({ja: "コピ�?�しました", en: "Copied"}) + " : " + aMsg, 2000);
        }
        ...
        function tweet(aInitialInput, aReplyID, aCursorEnd) {
            ...
            prompt.reader({
                ...
                onChange     : function (arg) {
                    ...
                    var msg = M({ja: ("残り " + acceptableCharCount + " �?�?"), en: acceptableCharCount});
                    if (acceptableCharCount < 0)
                        msg = M({ja: ((-acceptableCharCount) + " �?字オーバ�?�"), en: ("Over " + (-acceptableCharCount) + " characters")});
                    display.echoStatusBar(msg);
                },
        ...
        function deleteStatus(aStatusID) {
            twitterAPI.request("statuses/destroy", {
                ...
                ok: function (res, xhr) {
                    ...
                    display.echoStatusBar(M({ja: 'ス�?ータスが削除されました',
                                             en: "Status deleted"}), 2000);
                },
                ng: function (res, xhr) {
                    display.echoStatusBar(M({ja: 'ス�?ータスの削除に失敗しました�?',
        ...
        function showListStatuses(aScreenName, aListName) {
            twitterAPI.request("lists/statuses", {
                ...
                ok: function (res, xhr) {
                    ...
                    callSelector(
                        statuses,
                        M({ja: util.format("%s/%s のタイ�?ライン", aScreenName, aListName),
                           en: util.format("Timeline of %s/%s", aScreenName, aListName)})
                    );
                },
                ng: function (res, xhr) {
                    display.echoStatusBar(M({ja: 'ス�?ータスの取得に失敗しました�? (自�?のプライベ�?�トリスト�?�取得できません�?)',
        ...
        function showLists(aScreenName) {
            ...
            else
            {
                twitterAPI.request("lists/index", {
                    ...
                    ng: function (res) {
                        display.echoStatusBar(M({ja: 'リスト�?覧の取得に失敗しました�?',
        ...
        function showConversations(id, init) {
            ...
            display.echoStatusBar(M({ja: "会話リスト�?�取得を開�?. し�?�らくお�?ち下さ�?.",
        ...
        function showCrawlersCache(crawler, arg, cacheFilter) {
            ...
            if (updateForced || !crawler.cache)
            {
                if (crawler.pending)
                {
                    display.echoStatusBar(M({ja: 'Twitter へリクエストを送信して�?ます�?�しばらくお�?ち下さ�?�?',
        ...
        function callSelector(aStatuses, aMessage, options) {
            ...
            if (!aMessage)
                aMessage = M({ja: "タイ�?ライン", en: "Timeline"});
            ...
            prompt.selector({
                ...
                header     : [M({ja: 'ユーザ', en: "User"}), aMessage, M({ja : "�?報", en: 'Info'})],
        ...
        var self = {
                    ...
                    if (isLink)
                    {
                        if (text[0] === '@')
                        {
                            ...
                            showDynamicMenu(aEvent, [
                                [util.format(M({ja: "%s のス�?ータスを�?覧表示", en: "Display %s's status"}), userName), "s",
                                 root + util.format(".showTargetStatus('%s');", userName)],
                                [util.format(M({ja: "%s の Twitter ホ�?��?へ", en: "%s in twitter"}), userName), "h",
                        ...
                        {
                            let actions = [
                                [M({ ja: "こ�?�ハッシュタグをトラ�?キングする", en: "Track this hash tag" }),
                                 null,
                        ...
                        else
                        {
                            ...
                            let actions = [
                                ...
                                [M({ja: "URL をコピ�?�", en: "Copy URL"}), "c",
                                 'KeySnail.modules.command.setClipboardText("' + url + '")']
                            ];

                            if (url.match("^http://(j\\.mp|bit\\.ly)/"))
                            {
                                actions.push([M({ja: "URL がクリ�?クされた回数を表示", en: "Inspect this link"}), "i",
            ...
            togglePopupStatus: function () {
                ...
                display.echoStatusBar(M({ja: ("ポップア�?プ�?�知�?" + (toggled ? "有効にしました" : "無効にしました")),
            ...
            updateStatusbar: function () {
                ...
                if (gStatuses.cache)
                {
                    ...
                    unreadStatusLabel.parentNode.setAttribute(
                        "tooltiptext",
                        unreadStatusCount + M({ja: " 個�?�未読ス�?ータスがありま�?", en: " unread statuses"})
                    );
                ...
                if (gMentions.cache)
                {
                    ...
                    unreadMentionLabel.parentNode.setAttribute(
                        "tooltiptext",
                        unreadMentionCount + M({ja: " 個�?�あなたへの @ (�?�?) がありま�?", en: " unread mentions"})
                    );
                ...
                if (gDMs.cache)
                {
                    ...
                    unreadDMLabel.parentNode.setAttribute(
                        "tooltiptext",
                        unreadDMCount + M({ja: " 個�?�あなた�? DM がありま�?", en: " direct messages"})
                    );
            ...
            addTracking: function (init) {
                ...
                let word = window.prompt(M({ en: "Input the word to track (beginning with the # means hash tag)",
                                             ja: "トラ�?キングした�?単語を入力してください (# から始めるとハッシュタグになりま�?)" }), init);
            ...
            trackingButtonClicked: function (ev) {
                ...
                case 2:
                    showDynamicMenu(ev, [
                        ...
                        [M({ ja: 'トラ�?キング間隔を変更', en: 'Change tracking interval' }),
                         null,
                         root + util.format(".changeTrackingInterval('%s');", escapedName)],
                        [M({ ja: 'トラ�?キングを終�?', en: 'Cancel tracking this word' }),
                         null,
